// AsCoolGridCellDateTime.cpp: implementation of the CAsCoolGridCellDateTime class.

#include "stdafx.h"
#include "AsCoolGridCtrl.h"
#include "AsCoolGridCell.h"
#include "AsCoolGridCellDateTime.h"
...
//////////////////////////////////////////////////////////////////////
// CAsCoolGridCellDateTime

IMPLEMENT_DYNCREATE(CAsCoolGridCellDateTime, CAsCoolGridCell)

//////////////////////////////////////////////////////////////////////
// Construction/Destruction
//////////////////////////////////////////////////////////////////////

CAsCoolGridCellDateTime::CAsCoolGridCellDateTime() : CAsCoolGridCell()
{
	m_dwStyle = 0;
	m_cTime   = CTime::GetCurrentTime();
}

CAsCoolGridCellDateTime::CAsCoolGridCellDateTime(DWORD dwStyle) : CAsCoolGridCell()
{
	Init(dwStyle);
}

CAsCoolGridCellDateTime::~CAsCoolGridCellDateTime()
{
}

CSize CAsCoolGridCellDateTime::GetCellExtent(CDC* pDC)
{    
...
BOOL CAsCoolGridCellDateTime::Edit(int nRow, int nCol, CRect rect, CPoint /* point */, 
							 UINT nID, UINT nChar)
{
	m_bEditing = TRUE;
...
CWnd* CAsCoolGridCellDateTime::GetEditWnd() const
{
	return m_pEditWnd;
}

void CAsCoolGridCellDateTime::EndEdit()
{
	if (m_pEditWnd) ((CInPlaceDateTime*)m_pEditWnd)->EndEdit();
}

void CAsCoolGridCellDateTime::Init(DWORD dwStyle)
{
	m_dwStyle = dwStyle;
...
void CAsCoolGridCellDateTime::SetTime(CTime time)
{
	m_cTime = time;
