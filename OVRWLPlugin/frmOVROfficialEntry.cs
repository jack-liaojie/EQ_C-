...
namespace AutoSports.OVRWLPlugin
{
    public partial class frmOVROfficialEntry : DevComponents.DotNetBar.Office2007Form
    {
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            if (m_iMatchID > 0)
            {
                ...
                for (int i = 0; i < dgvAvailOfficial.SelectedRows.Count; i++)
                {
                    ...
                    {
                        iPositionID = Str2Int(strPositionID);
                    }
                    AddMatchOfficial(m_iMatchID, iRegisterID, iFunctionID, iPositionID);
                }
                ResetAvailableOfficial();
                ResetMatchOfficial();
            }
        ...
        private void Localization()
        {
            ...
            btnXGroup.Text = LocalizationRecourceManager.GetString(strSectionName, "OVRWLPlugin_OVRWLDataEntryForm_btnX_SetOfficialGroup");
        }
        ...
        public void AddMatchOfficial(int iMatchID, int iRegisterID, int iFunctionID,int iPostionID)
        {
            System.Data.SqlClient.SqlConnection con = GVWL.g_adoDataBase.DBConnect;
            if (con.State != ConnectionState.Open)
                con.Open();
            ...
            try
            {
                ...
                SqlParameter cmdParameter1 = new SqlParameter("@RegisterID", SqlDbType.Int);
                SqlParameter cmdParameter2 = new SqlParameter("@FunctionID", SqlDbType.Int);
                SqlParameter cmdParameter3 = new SqlParameter("@PositionID", SqlDbType.Int);
                SqlParameter cmdParameterResult = new SqlParameter("@Result", SqlDbType.Int);

                cmdParameter0.Value = iMatchID;
                cmdParameter1.Value = iRegisterID;
                cmdParameter2.Value = iFunctionID;
                cmdParameter3.Value = iPostionID;
                cmdParameterResult.Direction = ParameterDirection.Output;
        ...
        private void btnXGroup_Click(object sender, EventArgs e)
        {
            frmOVROfficialGroupEntry OfficialForm = new frmOVROfficialGroupEntry(m_iMatchID);
