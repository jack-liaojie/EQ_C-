...
namespace OVRRUPlugin.Common
{
    public class OVRRUDataBase
    {
        ...
        public void FillComb(String strProcName, string displayMember, string valueMember
            , System.Windows.Forms.ComboBox cmb, params SqlParameter[] aryProcParams)
        {
