...
namespace AutoSports.OVRWRPlugin
{
    public class GVAR
    {
        ...
        public const String g_strDisplnCode = "WR";
        public const String g_strDisplnName = "Wrestling";
        public const String g_strLang = "ENG";

        public static OVRWRPlugin g_WRPlugin;
        public static OVRWRDataBase g_adoDataBase;
        public static OVRWRManageDB g_ManageDB;
        public static int g_matchID;
        public static int g_matchSplitID;
        public static int g_matchTypeID;
        ...
        public const String m_strSectionName = "OVRWRPlugin";
