...
{
    public partial class frmOVRBKTeamMemberEntry : Office2007Form
    {
        ...
        public frmOVRBKTeamMemberEntry(int iMatchID, int iHRegID, int iVRegID, string strHName, string strVName)
        {
            InitializeComponent();
