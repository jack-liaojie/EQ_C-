// AsCoolGridCellNumeric.h: interface for the CAsCoolGridCellNumeric class.
//
...
class AX_OVRCOMMON_EXP CAsCoolGridCellNumeric : public CAsCoolGridCell  
{
    DECLARE_DYNCREATE(CAsCoolGridCellNumeric)
