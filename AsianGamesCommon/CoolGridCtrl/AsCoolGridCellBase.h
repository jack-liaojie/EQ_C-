/////////////////////////////////////////////////////////////////////////////
// AsCoolGridCellBase.h : header file
...
class AX_OVRCOMMON_EXP CAsCoolGridCellBase : public CObject
{
    friend class CAsCoolGridCtrl;
    DECLARE_DYNAMIC(CAsCoolGridCellBase)

// Construction/Destruction
public:
    CAsCoolGridCellBase();
    virtual ~CAsCoolGridCellBase();

// Operators
public:
	virtual void operator=(const CAsCoolGridCellBase& cell);
...
public:
    ...
    virtual void SetGrid(CAsCoolGridCtrl* /* pGrid */)            = 0 ;
    ...
    virtual CAsCoolGridCtrl* GetGrid() const                = 0 ;
    virtual CWnd     * GetEditWnd()    const                = 0 ;
    virtual UINT       GetMargin()     const                = 0 ;

    virtual CAsCoolGridCellBase* GetDefaultCell() const;
