// AsCoolGridCellDateTime.h: interface for the CAsCoolGridCellDateTime class.
...
class AX_OVRCOMMON_EXP CAsCoolGridCellDateTime : public CAsCoolGridCell  
{
  friend class CGridCtrl;
  DECLARE_DYNCREATE(CAsCoolGridCellDateTime)
...
public:
	...
	CAsCoolGridCellDateTime(DWORD dwStyle);
	virtual ~CAsCoolGridCellDateTime();
