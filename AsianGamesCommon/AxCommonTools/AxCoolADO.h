...
class AX_OVRCOMMON_EXP CAxADOUtils
{
public:
...
class AX_OVRCOMMON_EXP CAxADOException
{
public:
...
class AX_OVRCOMMON_EXP CAxADODataBase
{
public:
	CAxADODataBase();
...
class AX_OVRCOMMON_EXP CAxADORecordSet
{
public:
	CAxADORecordSet();
...
class AX_OVRCOMMON_EXP CAxADOParameter
{
public:
...
class AX_OVRCOMMON_EXP CAxADOCommand
{
public:
...
class AX_OVRCOMMON_EXP CAxADOOLEDBDataLink
{
public:
	CAxADOOLEDBDataLink();
...
class AX_OVRCOMMON_EXP CAxADOOLEDBException
{
public:
