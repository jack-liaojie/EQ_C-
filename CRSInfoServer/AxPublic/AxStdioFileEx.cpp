// StdioFileEx.cpp: implementation of the CAxStdioFileEx class.
//
...
/*static*/ const UINT CAxStdioFileEx::modeWriteUnicode = 0x20000; // Add this flag to write in Unicode

CAxStdioFileEx::CAxStdioFileEx(): CStdioFile()
{
	m_bIsUnicodeText = false;
	m_nFileCodePage = -1;
}

CAxStdioFileEx::CAxStdioFileEx(LPCTSTR lpszFileName,UINT nOpenFlags)
	:CStdioFile(lpszFileName, ProcessFlags(lpszFileName, nOpenFlags))
{
	m_nFileCodePage = -1;
}

void CAxStdioFileEx::SetCodePage(IN const UINT nCodePage)
{
	m_nFileCodePage = (int)nCodePage; 
}

BOOL CAxStdioFileEx::Open(LPCTSTR lpszFileName,UINT nOpenFlags,CFileException* pError /*=NULL*/)
{
...
BOOL CAxStdioFileEx::ReadString(CString& rString)
{
...
//					CAxStdioFileEx::modeWriteUnicode flag. Override of base class function.
...
// Exceptions:	None.
//
void CAxStdioFileEx::WriteString(LPCTSTR lpsz)
{
	wchar_t*	pszUnicodeString	= NULL; 
	char	*	pszMultiByteString= NULL;
	...
	try
	{
		...
		if (m_nFlags & CAxStdioFileEx::modeWriteUnicode)
		{
...
UINT CAxStdioFileEx::ProcessFlags(const CString& sFilePath, UINT& nOpenFlags)
{
	m_bIsUnicodeText = false;

	// If we have writeUnicode we must have write or writeRead as well
#ifdef _DEBUG
	if (nOpenFlags & CAxStdioFileEx::modeWriteUnicode)
	{
...
// Exceptions:	None.
//
/*static*/ bool CAxStdioFileEx::IsFileUnicode(const CString& sFilePath)
{
	CFile				file;
...
unsigned long CAxStdioFileEx::GetCharCount()
{
	int				nCharSize;
...
UINT CAxStdioFileEx::GetCurrentLocaleCodePage()
{
...
// --------------------------------------------------------------------------------------------
//
//	CAxStdioFileEx::GetUnicodeStringFromMultiByteString()
//
// --------------------------------------------------------------------------------------------
...
// Exceptions:	None.
//
int CAxStdioFileEx::GetUnicodeStringFromMultiByteString(IN LPCSTR szMultiByteString, OUT wchar_t* szUnicodeString, IN int nUnicodeBufferSize, IN int nCodePage)
{
	bool		bOK = true;
	int		nCharsWritten = 0;
...
// --------------------------------------------------------------------------------------------
//
//	CAxStdioFileEx::GetMultiByteStringFromUnicodeString()
//
// --------------------------------------------------------------------------------------------
...
// Exceptions:	None.
//
int CAxStdioFileEx::GetMultiByteStringFromUnicodeString(wchar_t * szUnicodeString, char* szMultiByteString, 
...
//---------------------------------------------------------------------------------------------------
//
//	CAxStdioFileEx::GetRequiredMultiByteLengthForUnicodeString()
//
//---------------------------------------------------------------------------------------------------
// Returns:    int
...
//
/*static*/ int CAxStdioFileEx::GetRequiredMultiByteLengthForUnicodeString(wchar_t * szUnicodeString,int nCodePage /*=-1*/)
{
	int nCharsNeeded = 0;
