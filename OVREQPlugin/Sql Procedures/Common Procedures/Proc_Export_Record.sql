...
/****** Object:  StoredProcedure [dbo].[Proc_Export_Record]    Script Date: 02/10/2011 16:39:14 ******/

IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[Proc_Export_Record]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[Proc_Export_Record]
GO
/****** Object:  StoredProcedure [dbo].[Proc_Export_Record]    Script Date: 02/10/2011 16:39:14 ******/
SET ANSI_NULLS ON
GO
...
CREATE PROCEDURE [dbo].[Proc_Export_Record]
