IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[Proc_Register_GetNOCAllRegister]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[Proc_Register_GetNOCAllRegister]
GO
/****** Object:  StoredProcedure [dbo].[Proc_Register_GetNOCAllRegister]    Script Date: 11/11/2009 15:19:00 ******/
SET ANSI_NULLS ON
GO
...
--名    称: [Proc_Register_GetNOCAllRegister]
--描    述: 获取指定NOC的报名信息
--参数说明: 
--说    明: 
--创 建 人: 邓年彩
...
CREATE PROCEDURE [dbo].[Proc_Register_GetNOCAllRegister]
	@NOC        			NVARCHAR(3),
	@DisciplineID			INT,
