IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[Proc_JU_UpdateMatchJudge]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[Proc_JU_UpdateMatchJudge]
GO
...
CREATE PROCEDURE [dbo].[Proc_JU_UpdateMatchJudge]
	@MatchID						INT,
	@ServantNum						INT,
	@RegisterID						INT,
	@FunctionID						INT,
