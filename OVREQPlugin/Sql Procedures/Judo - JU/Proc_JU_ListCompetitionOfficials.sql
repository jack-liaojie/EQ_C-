IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[Proc_JU_ListCompetitionOfficials]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[Proc_JU_ListCompetitionOfficials]
GO
...
--名    称: [Proc_JU_ListCompetitionOfficials]
--描    述: 柔道项目获取竞赛官员列表  
--创 建 人: 邓年彩
--日    期: 2010年11月8日 星期一
--修改记录：
...
CREATE PROCEDURE [dbo].[Proc_JU_ListCompetitionOfficials]
	@MatchID						INT,
