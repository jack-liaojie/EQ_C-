IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[Proc_TVG_JU_GetMedallists_Event]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[Proc_TVG_JU_GetMedallists_Event]
GO
...
--名    称: [Proc_TVG_JU_GetMedallists_Event]
--描    述: 柔道项目TVG单项奖牌 
...
CREATE PROCEDURE [dbo].[Proc_TVG_JU_GetMedallists_Event]
	@EventID						INT,
