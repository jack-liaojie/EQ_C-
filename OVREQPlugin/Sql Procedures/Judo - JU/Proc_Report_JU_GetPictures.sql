IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[Proc_Report_JU_GetPictures]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[Proc_Report_JU_GetPictures]
GO
...
--名    称: [Proc_Report_JU_GetPictures]
--描    述: 柔道项目报表获取图片信息, 如运动会图标, 体育项目图标, 赞助商图标等等,  
--创 建 人: 邓年彩
--日    期: 2010年9月15日 星期三
--修改记录：
/*			
...
CREATE PROCEDURE [dbo].[Proc_Report_JU_GetPictures]
	@DisciplineID					INT,
	@EventID						INT,
	@PhaseID						INT,
	@MatchID						INT,
