IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[Proc_TVG_JU_EventPhase]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[Proc_TVG_JU_EventPhase]
GO
...
CREATE PROCEDURE [dbo].[Proc_TVG_JU_EventPhase]
	@MatchID							INT
AS
BEGIN
SET NOCOUNT ON
