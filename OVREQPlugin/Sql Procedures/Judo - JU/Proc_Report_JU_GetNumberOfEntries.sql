IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[Proc_Report_JU_GetNumberOfEntries]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[Proc_Report_JU_GetNumberOfEntries]
GO
...
--名    称: [Proc_Report_JU_GetNumberOfEntries]
--描    述: 柔道项目报表 C30 (Number of Entries by NOC) 获取详细信息
--创 建 人: 邓年彩
--日    期: 2010年9月25日 星期六
--修改记录：
/*			
...
CREATE PROCEDURE [dbo].[Proc_Report_JU_GetNumberOfEntries]
	@DisciplineID					INT,
