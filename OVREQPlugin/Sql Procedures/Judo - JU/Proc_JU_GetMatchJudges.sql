IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[Proc_JU_GetMatchJudges]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[Proc_JU_GetMatchJudges]
GO
...
CREATE PROCEDURE [dbo].[Proc_JU_GetMatchJudges]
	@MatchID						INT,
