IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[Proc_JU_GetDataEntryTitle]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[Proc_JU_GetDataEntryTitle]
GO
...
CREATE PROCEDURE [dbo].[Proc_JU_GetDataEntryTitle]
	@MatchID						INT,
