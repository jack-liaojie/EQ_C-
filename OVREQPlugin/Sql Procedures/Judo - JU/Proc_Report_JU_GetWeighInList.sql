IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[Proc_Report_JU_GetWeighInList]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[Proc_Report_JU_GetWeighInList]
GO
...
--名    称: [Proc_Report_JU_GetWeighInList]
--描    述: 获取体重称量表的主要内容.
--创 建 人: 邓年彩
--日    期: 2010年11月8日 星期一
--修改记录：
...
CREATE PROCEDURE [dbo].[Proc_Report_JU_GetWeighInList]
	@EventID						INT,
	@LanguageCode					CHAR(3)
AS
BEGIN
