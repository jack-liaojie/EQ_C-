IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[Proc_TVG_JU_GetEvents]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[Proc_TVG_JU_GetEvents]
GO
...
CREATE PROCEDURE [dbo].[Proc_TVG_JU_GetEvents]
