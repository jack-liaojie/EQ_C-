IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[Proc_SCB_JU_New_GetMatchs]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[Proc_SCB_JU_New_GetMatchs]
GO
...
CREATE PROCEDURE [dbo].[Proc_SCB_JU_New_GetMatchs]
	@SessionID					INT,
	@EventID					INT,
...
-- Just for test
EXEC [Proc_SCB_JU_New_GetMatchs] 944,17,N'F25TK04'
