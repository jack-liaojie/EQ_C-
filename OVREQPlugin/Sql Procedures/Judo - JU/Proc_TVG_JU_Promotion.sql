IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[Proc_TVG_JU_Promotion]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[Proc_TVG_JU_Promotion]
GO
...
CREATE PROCEDURE [dbo].[Proc_TVG_JU_Promotion]
	@EventID						INT,
