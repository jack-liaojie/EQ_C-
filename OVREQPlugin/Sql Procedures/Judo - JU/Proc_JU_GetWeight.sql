IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[Proc_JU_GetWeight]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[Proc_JU_GetWeight]
GO
...
CREATE PROCEDURE [dbo].[Proc_JU_GetWeight]
	@EventID							INT
AS
BEGIN
SET NOCOUNT ON
