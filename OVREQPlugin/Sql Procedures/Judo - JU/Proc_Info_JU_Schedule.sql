IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[Proc_Info_JU_Schedule]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[Proc_Info_JU_Schedule]
GO
...
CREATE PROCEDURE [dbo].[Proc_Info_JU_Schedule]
		@SessionID			INT
AS
BEGIN
