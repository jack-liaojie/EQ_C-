IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[Proc_Report_JU_GetEventList]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[Proc_Report_JU_GetEventList]
GO
...
CREATE PROCEDURE [dbo].[Proc_Report_JU_GetEventList]
	@DisciplineID						INT,
