IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[Proc_JU_UpdatetWeight]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[Proc_JU_UpdatetWeight]
GO
...
CREATE PROCEDURE [dbo].[Proc_JU_UpdatetWeight]
	@EventID							INT,
	@Noc								NVARCHAR(3),
	@Name								NVARCHAR(50),
	@Weight								NVARCHAR(10),
