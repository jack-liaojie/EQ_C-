IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[Proc_JU_GetDecisionList]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[Proc_JU_GetDecisionList]
GO
...
--名    称: [Proc_JU_GetDecisionList]
--描    述: 柔道项目获取 Decision 列表.
--创 建 人: 邓年彩
--日    期: 2010年11月6日 星期六
--修改记录：
/*			
...
CREATE PROCEDURE [dbo].[Proc_JU_GetDecisionList]
