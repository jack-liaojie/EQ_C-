IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[Proc_Report_GF_SummaryByRound]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[Proc_Report_GF_SummaryByRound]
GO
...
--名    称: [Proc_Report_GF_SummaryByRound]
--描    述: 为C84A报表服务
--参数说明: 
--说    明: 
--创 建 人: 张翠霞
...
CREATE PROCEDURE [dbo].[Proc_Report_GF_SummaryByRound]
	@MatchID				INT,
	@LanguageCode			CHAR(3)
AS
BEGIN
