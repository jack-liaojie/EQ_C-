IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[Func_Report_SL_GetDateTime]') AND type in (N'FN', N'IF', N'TF', N'FS', N'FT'))
DROP FUNCTION [dbo].[Func_Report_SL_GetDateTime]
GO
...
CREATE FUNCTION [dbo].[Func_Report_SL_GetDateTime]
(
