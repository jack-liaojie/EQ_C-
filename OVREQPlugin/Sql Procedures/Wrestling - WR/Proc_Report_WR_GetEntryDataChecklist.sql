IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[Proc_Report_WR_GetEntryDataChecklist]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[Proc_Report_WR_GetEntryDataChecklist]
GO
...
--名    称: [Proc_Report_WR_GetEntryDataChecklist]
--描    述: 摔跤报表 C38 (Entry Data Checklist), 获取主要信息.
--创 建 人: 宁顺泽
--日    期: 2011年10月1日 星期1
--修改记录：
/*			
...
CREATE PROCEDURE [dbo].[Proc_Report_WR_GetEntryDataChecklist]
	@DisciplineID				INT,
	@DelegationID				INT,
	@NOCID						CHAR(3),
	@LanguageCode				CHAR(3)
