IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[Proc_TVG_WR_GetMatchJudges]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[Proc_TVG_WR_GetMatchJudges]
GO
...
--名    称: [Proc_TVG_WR_GetMatchJudges]
...
CREATE PROCEDURE [dbo].[Proc_TVG_WR_GetMatchJudges]
	@MatchID						INT,
