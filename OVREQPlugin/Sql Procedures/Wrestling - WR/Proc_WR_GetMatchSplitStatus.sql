IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[Proc_WR_GetMatchSplitStatus]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[Proc_WR_GetMatchSplitStatus]
GO
...
--名    称: [Proc_WR_GetMatchSplitStatus]
--描    述: 获取Match状态
--创 建 人: 宁顺泽
--日    期: 2011年7月11日 星期1
--修改记录：
...
CREATE PROCEDURE [dbo].[Proc_WR_GetMatchSplitStatus]
	@SessionNumber					INT,
	@CourtID						INT,
	@MatchNo						INT,
	@MatchSplitID					INT,
