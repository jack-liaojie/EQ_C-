IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[Proc_WR_GetMatchJudgeTitle]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[Proc_WR_GetMatchJudgeTitle]
GO
...
--名    称: [Proc_WR_GetMatchJudgeTitle]
...
CREATE PROCEDURE [dbo].[Proc_WR_GetMatchJudgeTitle]
	@MatchID						INT,
