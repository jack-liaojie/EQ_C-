IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[Proc_WR_AddMatchJudge]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[Proc_WR_AddMatchJudge]
GO
...
CREATE PROCEDURE [dbo].[Proc_WR_AddMatchJudge]
	@MatchID						INT,
	@RegisterID						INT,
	@FunctionID						INT,
	@Result							INT OUTPUT
