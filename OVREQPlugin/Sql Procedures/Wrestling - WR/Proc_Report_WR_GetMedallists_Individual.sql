IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[Proc_Report_WR_GetMedallists_Individual]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[Proc_Report_WR_GetMedallists_Individual]
GO
...
--名    称: [Proc_Report_WR_GetMedallists_Individual]
...
CREATE PROCEDURE [dbo].[Proc_Report_WR_GetMedallists_Individual]
	@EventID						INT,
	@LanguageCode					CHAR(3)
AS
BEGIN
