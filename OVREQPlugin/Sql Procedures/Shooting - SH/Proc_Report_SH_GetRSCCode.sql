IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[Proc_Report_SH_GetRSCCode]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[Proc_Report_SH_GetRSCCode]
GO
SET ANSI_NULLS ON
GO
...
CREATE PROCEDURE [dbo].[Proc_Report_SH_GetRSCCode]
	@DisciplineID INT,
	@EventID	  INT,
	@PhaseID	  INT,
	@MatchID	  INT,
