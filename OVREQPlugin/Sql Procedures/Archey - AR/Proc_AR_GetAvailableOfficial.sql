IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[Proc_AR_GetAvailableOfficial]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[Proc_AR_GetAvailableOfficial]
GO
...
--名    称：[Proc_AR_GetAvailableOfficial]
--描    述：得到Match下可选的裁判信息
--参数说明： 
--说    明：
--创 建 人：崔凯
...
CREATE PROCEDURE [dbo].[Proc_AR_GetAvailableOfficial](
                                                @DisciplineID       INT,
												@MatchID		    INT,
...
/*
EXEC Proc_AR_GetAvailableOfficial 1,73,'eng'
*/
