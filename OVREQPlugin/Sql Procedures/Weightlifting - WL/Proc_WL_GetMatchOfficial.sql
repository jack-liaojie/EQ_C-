IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[Proc_WL_GetMatchOfficial]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[Proc_WL_GetMatchOfficial]
GO
...
CREATE PROCEDURE [dbo].[Proc_WL_GetMatchOfficial](
												@MatchID		    INT,
