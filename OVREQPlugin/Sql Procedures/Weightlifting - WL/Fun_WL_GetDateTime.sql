IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[Fun_WL_GetDateTime]') AND type in (N'FN', N'IF', N'TF', N'FS', N'FT'))
DROP FUNCTION [dbo].[Fun_WL_GetDateTime]
GO
...
CREATE FUNCTION [Fun_WL_GetDateTime]
(
	@DateTime				DateTime,
	@Type					INT,
