IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[Proc_Report_WL_GetReportIdentifier]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[Proc_Report_WL_GetReportIdentifier]
GO
...
--名    称: [Proc_Report_WL_GetReportIdentifier]
--描    述: 项目报表获取 Report Identifier 的组成元素, 如 Discipline Code(2), Gender(1), Event Code(3), Phase(1), EventUnit(5) 等等. 
--参数说明: 
--说    明: 
--创 建 人: 吴定昉
--日    期: 2010年10月19日
...
CREATE PROCEDURE [dbo].[Proc_Report_WL_GetReportIdentifier]
	@DisciplineID					INT,
	@EventID						INT,
	@PhaseID						INT,
	@MatchID						INT,
...
-- Just for test
EXEC [Proc_Report_WL_GetReportIdentifier] NULL, NULL, NULL, NULL, NULL, NULL, NULL
EXEC [Proc_Report_WL_GetReportIdentifier] NULL, NULL, NULL, NULL, NULL, NULL, N'ALL'
