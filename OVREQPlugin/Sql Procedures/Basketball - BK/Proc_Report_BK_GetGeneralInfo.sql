IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[Proc_Report_BK_GetGeneralInfo]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[Proc_Report_BK_GetGeneralInfo]
GO
...
--名    称: [Proc_Report_BK_GetGeneralInfo]
...
CREATE PROCEDURE [dbo].[Proc_Report_BK_GetGeneralInfo]
	@DisciplineID					INT,
	@EventID						INT,
	@PhaseID						INT,
	@MatchID						INT,
	...
	BEGIN
		SELECT 
			...
			, CASE @LanguageCode WHEN 'CHN' THEN 
			  ...
			  ELSE (DATENAME(day,GETDATE()) + ' ' + LEFT(UPPER(DATENAME(month,GETDATE())), 3) + ' ' + DATENAME(year,GETDATE())) END AS [Date]
			, N'Start Time' AS [StartTime]
			, N'End Time' AS [EndTime]
			, ( dbo.Fun_GetWeekdayName(GETDATE(), @LanguageCode) + ' ' + DATENAME(day,GETDATE()) + ' ' + LEFT(UPPER(DATENAME(month,GETDATE())), 3) + ' ' + DATENAME(year,GETDATE()) + ' ' + DATENAME(hour,GETDATE()) + ':' + RIGHT((N'00'+DATENAME(minute,GETDATE())),2)) AS [CreatedTime]
...
-- Just for test
EXEC [Proc_Report_BK_GetGeneralInfo] NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'ENG'
EXEC [Proc_Report_BK_GetGeneralInfo] NULL, NULL, NULL, NULL, NULL,  NULL, N'','CHN'
EXEC [Proc_Report_BK_GetGeneralInfo] NULL, 109, NULL, NULL, NULL, NULL, N'C51C',  'CHN'
EXEC [Proc_Report_BK_GetGeneralInfo] NULL, NULL, NULL, 2538, NULL, NULL, N'C73',  'ENG'
EXEC [Proc_Report_BK_GetGeneralInfo] NULL, NULL, NULL, 2538, NULL, NULL, N'C73',  'CHN'
