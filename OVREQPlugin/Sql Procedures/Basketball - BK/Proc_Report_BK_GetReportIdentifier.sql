IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[Proc_Report_BK_GetReportIdentifier]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[Proc_Report_BK_GetReportIdentifier]
GO
...
--名    称: [Proc_Report_BK_GetReportIdentifier]
...
CREATE PROCEDURE [dbo].[Proc_Report_BK_GetReportIdentifier]
	@DisciplineID					INT,
	@EventID						INT,
	@PhaseID						INT,
	@MatchID						INT,
...
-- Just for test
EXEC [Proc_Report_BK_GetReportIdentifier] NULL, NULL, NULL, NULL, NULL, NULL, NULL
EXEC [Proc_Report_BK_GetReportIdentifier] NULL, NULL, NULL, NULL, NULL, NULL, N'ALL'
