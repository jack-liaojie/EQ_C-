IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[Proc_Report_BK_GetMedalMembers]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[Proc_Report_BK_GetMedalMembers]
GO
...
--名    称: [Proc_Report_BK_GetMedalMembers]
...
CREATE PROCEDURE [dbo].[Proc_Report_BK_GetMedalMembers]
	@DisciplineID						INT,
	@LanguageCode						CHAR(3)
AS
BEGIN
