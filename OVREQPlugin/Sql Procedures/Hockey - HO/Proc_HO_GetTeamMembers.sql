IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[Proc_HO_GetTeamMembers]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[Proc_HO_GetTeamMembers]
GO
...
CREATE PROCEDURE [dbo].[Proc_HO_GetTeamMembers]
                 @MatchID             INT,   
                 @TeamPos             INT,
...
/*GO
EXEC Proc_HO_GetTeamMembers 1,1,'CHN'*/