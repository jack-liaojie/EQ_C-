...
/****** Object:  StoredProcedure [dbo].[Proc_Report_HB_TeamStartList]    Script Date: 08/29/2012 09:58:54 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[Proc_Report_HB_TeamStartList]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[Proc_Report_HB_TeamStartList]
GO
...
--名    称：[Proc_Report_HB_TeamStartList]
...
CREATE PROCEDURE [dbo].[Proc_Report_HB_TeamStartList](
												@MatchID		    INT,
