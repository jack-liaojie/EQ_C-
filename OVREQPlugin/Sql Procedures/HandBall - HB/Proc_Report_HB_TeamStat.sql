...
/****** Object:  StoredProcedure [dbo].[Proc_Report_HB_TeamStat]    Script Date: 08/29/2012 10:01:24 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[Proc_Report_HB_TeamStat]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[Proc_Report_HB_TeamStat]
GO
...
CREATE PROCEDURE [dbo].[Proc_Report_HB_TeamStat](
												@MatchID		    INT,
												@LanguageCode		CHAR(3)
