...
/****** Object:  StoredProcedure [dbo].[Proc_HB_GetTeamDetailInfo]    Script Date: 08/30/2012 08:41:26 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[Proc_HB_GetTeamDetailInfo]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[Proc_HB_GetTeamDetailInfo]
GO
...
CREATE PROCEDURE [dbo].[Proc_HB_GetTeamDetailInfo]
                 @MatchID             INT,   
                 @TeamID              INT,
                 @TeamPos             INT
