...
public:
	...
	void Show(LPCTSTR szCaption,DWORD dwTimeToStay=INFINITE,DWORD dwTimeToShow=400,DWORD dwTimeToHide=500,int nIncrement=1);
	void Hide();
...
extern CTaskbarNotifier g_WndPopupNotifier;
