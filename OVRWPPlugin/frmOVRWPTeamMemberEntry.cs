...
{
    public partial class frmOVRWPTeamMemberEntry : Office2007Form
    {
        ...
        public frmOVRWPTeamMemberEntry(int iMatchID, int iHRegID, int iVRegID, string strHName, string strVName)
        {
            InitializeComponent();
        ...
        private void dgvMember_Home_CellContentDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            if (e.RowIndex >= dgvMember_Home.RowCount || e.RowIndex < 0)
                return;
            if (e.ColumnIndex == dgvMember_Home.Columns["Startup"].Index)
                return;
        }

        private void dgvMember_Visit_CellContentDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            if (e.RowIndex >= dgvMember_Visit.RowCount || e.RowIndex < 0)
                return;
            if (e.ColumnIndex == dgvMember_Visit.Columns["Startup"].Index)
                return;
        }
        ...
        {
            GVAR.g_ManageDB.UpdateMatchUniform(m_iMatchID, 1, 2);
            GVAR.g_ManageDB.UpdateMatchUniform(m_iMatchID, 2, 1);
            ...
            cmbUniform_Home.DisplayMember = "F_UiformName";
            cmbUniform_Home.ValueMember = "F_UniformID";
            ...
            cmbUniform_Visit.DisplayMember = "F_UiformName";
            cmbUniform_Visit.ValueMember = "F_UniformID";
